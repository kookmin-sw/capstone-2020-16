                                 ...
                                 <Card elevation={1} className="flex flex-col h-128">
                                    ...
                                    >
                                       ...
                                       <Typography className="font-medium truncate" color="inherit">
                                          ...
                                          <h4>{`점수변동 : ${getScoreFlu(course.challenger, course.opposite, course.challenger_score_flu, course.opposite_score_flu)}`}</h4>
                                          <h4>{` ${course.title} 총 점수 : ${getScore(course.challenger, course.opposite, course.challenger_score, course.opposite_score)} `}</h4>
                                       </Typography>
                                    </div>
                                    <Divider />
