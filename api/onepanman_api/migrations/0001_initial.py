# Generated by Django 2.2.10 on 2020-02-14 02:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_column='NAME', max_length=20, verbose_name='코드이름')),
        ...
        migrations.CreateModel(
            name='GroupInfo',
            fields=[
                ('group', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, primary_key=True, serialize=False, to='auth.Group', verbose_name='그룹')),
                ('ranking', models.IntegerField(db_column='RANKING', verbose_name='랭킹')),
            ],
            options={
                'verbose_name': '그룹정보',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_column='NAME', max_length=30, unique=True, verbose_name='언어이름')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_column='NAME', max_length=30, unique=True, verbose_name='규칙이름')),
                ('description', models.TextField(db_column='DESCRIPTION', verbose_name='규칙설명')),
                ('type', models.CharField(db_column='TYPE', max_length=30, verbose_name='규칙종류')),
            ],
            options={
                'verbose_name': '규칙정보',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.ForeignKey(db_column='CODE', default=0, on_delete=django.db.models.deletion.PROTECT, to='onepanman_api.Code', verbose_name='대표 코드')),
                ('problem', models.ForeignKey(db_column='PROBLEM', on_delete=django.db.models.deletion.PROTECT, related_name='problem_userInformationInProblem_problem', to='onepanman_api.Problem', verbose_name='문제')),
        ...
        migrations.CreateModel(
            name='UserInfo',
            fields=[
                ('user', models.OneToOneField(db_column='USER', on_delete=django.db.models.deletion.PROTECT, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL, verbose_name='유저')),
                ('heart', models.IntegerField(db_column='HEART', default=5, verbose_name='하트')),
                ('theme', models.IntegerField(db_column='THEME', default=0, verbose_name='테마정보')),
                ...
                ('group', models.ForeignKey(db_column='GROUP', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='group_userInfo_group', to='auth.Group', verbose_name='그룹')),
                ('language', models.ForeignKey(db_column='LANGUAGE', default=0, on_delete=django.db.models.deletion.PROTECT, related_name='language_userInfo_language', to='onepanman_api.Language', verbose_name='주 사용 언어')),
            ],
            options={
                'verbose_name': '유저 정보',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(db_column='RECEIVER', default=0, on_delete=django.db.models.deletion.PROTECT, related_name='user_notice_receiver', to=settings.AUTH_USER_MODEL, verbose_name='수신자')),
                ('sender', models.ForeignKey(db_column='SENDER', default=0, on_delete=django.db.models.deletion.PROTECT, related_name='user_notice_sender', to=settings.AUTH_USER_MODEL, verbose_name='발신자')),
            ],
            options={
                'verbose_name': '알림정보',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False, verbose_name='ID')),
                ('comment_index', models.IntegerField(db_column='COMMENT_INDEX', default=0, verbose_name='댓글 번호')),
                ...
                ('article', models.ForeignKey(db_column='ARTICLE', on_delete=django.db.models.deletion.CASCADE, related_name='article_comment_article', to='onepanman_api.Article', verbose_name='게시글')),
